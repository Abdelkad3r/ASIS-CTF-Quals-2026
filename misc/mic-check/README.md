...
| **Category** | misc / warm-up |
| **Files** | [`challenge.txt`](challenge.txt), [`solve.py`](solve.py), [`writeup.html`](writeup.html) |
| **Published writeup** | [https://claude.ai/code/artifact/96cdf208-78ac-4b31-a496-d065ccd7ea93](https://claude.ai/code/artifact/96cdf208-78ac-4b31-a496-d065ccd7ea93) |
...
[`solve.py`](solve.py) implements the above directly against the unmodified art:
